...
\textbf{Fase 1: Localización inicial (find\_any\_recursive)}
...
\textbf{Fase 2: Expansión izquierda (find\_leftmost\_recursive)}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Realiza una llamada recursiva a la izquierda: \(\texttt{find\_leftmost\_recursive}(\text{...}, \texttt{low}, \texttt{mid} - 1, \text{...})\)
...
\textbf{Fase 3: Expansión derecha (find\_rightmost\_recursive)}
